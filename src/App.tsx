...
function RootLayout() {
  ...
  return (
      <AuthProvider authConfig={{
        ...
        authorizationEndpoint: "https://cs509-newegg.auth.us-east-2.amazoncognito.com/oauth2/authorize",
        tokenEndpoint: "https://cs509-newegg.auth.us-east-2.amazoncognito.com/oauth2/token",
        logoutEndpoint: "https://cs509-newegg.auth.us-east-2.amazoncognito.com/logout",
        ...
        autoLogin: false,
        postLogin: () => {
            const item = JSON.parse(sessionStorage.getItem("ROCP_auth_state")?? "null");
